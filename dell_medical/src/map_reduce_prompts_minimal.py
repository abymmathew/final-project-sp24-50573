...
# Map
map_template = """You are an excellent healthcare executive assistant. You get an automated meeting transcript with transcription error due to autmoatic voice recognition, please ignore those. \n
...
# Reduce
reduce_template = """You are an excellent healthcare executive assistant. The following is a set of excerpts from meeting transcripts of a recent hybrid meeting: \n
Excerpt:`{text}`\n
...
bullet_prompt = ChatPromptTemplate.from_template(
    """
    You are an excellent healthcare executive assistance. You are given a summary of a interview:\n
    ...
    Highlight Key Elements: Emphasize Insights, Emotions, decisions, action items, and dates.\n
    ...
    Include one section containing all Insights that was observed.\n
    Include one section containing all Emotions that was observed related to the healthcare events.\n
